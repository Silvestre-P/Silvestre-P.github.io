...
const CONFIG = {
  github: {
    username: 'Silvestre-P', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    ...
    external: {
      ...
      projects: [
        {
          title: 'Evolutionary Processes and diversity patterns of European dragonfiles',
          description:
